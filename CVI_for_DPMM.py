""""
SVB collapsed DPM as in Kurihara et al. (2007).
"""

import numpy as np
from scipy.special import digamma, gammaln
from Auxiliary_functions import E_log_p_of_z_given_other_z, ELBO_term_for_pz, lowerbound
...
def CV_DPMM(X, T=10, max_iter=100, alpha=1., thresh=1e-3):
    ...
    for batch in range(B):
        ...
        # Update priors with the variational posteriors of the previous batch (SVB)
        if batch > 0:
